        ...
        <tr>
            <td class="one-column">
                <table width="100%">
                    <tr>
                        <td class="inner-td">
                            <p style="padding-left: 20px; color: black">Dear <b>{{ $name_spec }}</b>,
                                <br>
                                <br>
                            <p style="padding-left: 20px; color: black">

                                Your KPI has been submitted on <?php date_default_timezone_set('Asia/Jakarta');
                                echo date('d-M-Y H:i A'); ?>.
                                <b>{{ $name_coor ?? $name_lead }}</b> will <a
                                    style="color:blue;text-decoration: underline;"
                                    href="{{ route('assessment_kpi_waiting', ['id' => $crement]) }}">review</a> your KPI
                                for approval process.</p>
                            <br>
