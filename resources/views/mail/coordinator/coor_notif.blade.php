        ...
        <tr>
            <td class="one-column">
                <table width="100%">
                    <tr>
                        <td class="inner-td">
                            <p style="padding-left: 20px; color: black">Dear <b>{{ $name_coor ?? $name_lead }},</b>
                                <br>
                                <br>
                            <p style="padding-left: 20px; color: black">

                                <b>{{ $name_spec }}</b> has submitted KPI on <?php date_default_timezone_set('Asia/Jakarta');
                                echo date('d-M-Y H:i A'); ?> and need your <a
