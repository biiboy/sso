                  ...
                  <table>
                    <tr>
                      <td style="font-family: sans-serif; font-size: 16px;">
                        <p style="font-family: sans-serif; font-size: 16px; font-weight: normal; Margin-bottom: 15px;">Dear <b>{{ $name_coor }},</b></p>

                        <p style="padding-left: 20px">
                      Thank you for completed your KPI <?php date_default_timezone_set("Asia/Jakarta"); echo date('d-M-Y H:i A') ?>.</p>
