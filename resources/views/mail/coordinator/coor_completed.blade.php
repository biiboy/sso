                  ...
                  <table>
                    <tr>
                      <td style="font-family: sans-serif; font-size: 16px;">
                        <p style="font-family: sans-serif; font-size: 16px; font-weight: normal; Margin-bottom: 15px;"><b>Dear {{ $name_coor }},</b></p>

                        <p style="font-family: sans-serif; font-size: 16px; font-weight: normal; margin: 0; Margin-bottom: 15px;"> KPI <b>{{ $name_spec }}</b> has been completed on <?php date_default_timezone_set("Asia/Jakarta"); echo date('d-M-Y H:i A') ?> and need your <a style="color:blue;text-decoration: underline;" href="{{ route('assessment_all_approval_appraisal',['id'=>$crement]) }}">evaluation</a>.</p>
                        ...
                        <p style="font-family: sans-serif; font-size: 16px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                            @if (($k_collab_helpdesk == 'ya') && ($k_collab_assets == null) && ($k_collab_support == null))
                              <label class="page-title">Collab With IT Helpdesk </label>
                        
                              @elseif (($k_collab_helpdesk == 'ya') && ($k_collab_assets == 'ya') && ($k_collab_support == null))
                                <label class="page-title">Collaboration With IT Asset dan Helpdesk</label>

                              @elseif (($k_collab_helpdesk == 'ya') && ($k_collab_assets == null) && ($k_collab_support == 'ya'))
                                <label class="page-title">Collaboration With IT Support dan IT Helpdesk</label>
                              ...
                              @if (($k_collab_helpdesk == null) && ($k_collab_assets == 'ya') && ($k_collab_support == null))
                                  <label class="page-title">Collab With IT Asset </label>

                              @elseif (($k_collab_helpdesk == null) && ($k_collab_assets == 'ya') && ($k_collab_support == 'ya'))
                                  <label class="page-title">Collaboration With IT Asset dan IT Support</label>
                                  
                              @elseif (($k_collab_helpdesk == null) && ($k_collab_assets == null) && ($k_collab_support == 'ya'))
                                  <label class="page-title">Collaboration With IT Support</label>
                              @endif
