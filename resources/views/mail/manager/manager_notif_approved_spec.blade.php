                                    ...
                                    <td style="font-family: sans-serif; font-size: 16px;">
                                        ...
                                        @if ($k_created_by == 28 ||
                                            ...
                                            <p
                                                ...
                                                You have approved KPI <b>{{ $name_coor }}</b> on <?php date_default_timezone_set('Asia/Jakarta');
                                                echo date('d-M-Y H:i A'); ?>.
                                            </p>
                                        @elseif ($k_created_by == 26 || $k_created_by == 27)
                                            <p
                                                style="font-family: sans-serif; font-size: 16px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                                You have approved KPI <b>{{ $name_lead }}</b> on <?php date_default_timezone_set('Asia/Jakarta');
                                                echo date('d-M-Y H:i A'); ?>.
                                            </p>
                                        @else
                                            <p
