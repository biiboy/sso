                  ...
                  <table>
                    <tr>
                      <td style="font-family: sans-serif; font-size: 16px;">
                        <p style="font-family: sans-serif; font-size: 16px; font-weight: normal; Margin-bottom: 15px;">Dear <b>{{ $name_manager }},</b></p>

                        @if ($k_created_by == 46)
                         <p style="font-family: sans-serif; font-size: 16px; font-weight: normal; margin: 0; Margin-bottom: 15px;">KPI <b>{{ $name_coor }}</b> has been completed on <?php date_default_timezone_set("Asia/Jakarta"); echo date('d-M-Y H:i A') ?> and need your <a style="color:blue;text-decoration: underline;" href="{{ route('assessment_all_approval_appraisal',['id'=>$crement]) }}">evaluation</a>.</p>


                        @elseif ($k_created_by == 26 || $k_created_by == 27 )
                         <p style="font-family: sans-serif; font-size: 16px; font-weight: normal; margin: 0; Margin-bottom: 15px;">KPI <b>{{ $name_lead }}</b> has been completed on <?php date_default_timezone_set("Asia/Jakarta"); echo date('d-M-Y H:i A') ?> and need your <a style="color:blue;text-decoration: underline;" href="{{ route('assessment_all_approval_appraisal',['id'=>$crement]) }}">evaluation</a>.</p>
                        ...
                        <!-- Goal -->
                        <p style="font-family: sans-serif; font-size: 16px; font-weight: normal; margin: 0;"><b>Goal:</b>
