                                    ...
                                    <td style="font-family: sans-serif; font-size: 16px;">
                                        ...
                                        @if ($k_created_by == 28 ||
                                            ...
                                            <p
                                                ...
                                                <b>{{ $name_manager }}</b> has approved KPI <b>{{ $name_coor }}</b>
                                        ...
                                        @elseif ($k_created_by == 26 || $k_created_by == 27)
                                            <p
                                                style="font-family: sans-serif; font-size: 16px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                                Your KPI has been approved by <b>{{ $name_manager }}</b> on
                                                <?php date_default_timezone_set('Asia/Jakarta');
                                                echo date('d-M-Y H:i A'); ?>.</p>
                                        @else
                                            <p
                                                style="font-family: sans-serif; font-size: 16px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                                <b>{{ $name_manager }}</b> has approved KPI
                                                <b>{{ $name_spec or $name_coor }}</b> on <?php date_default_timezone_set('Asia/Jakarta');
                                                echo date('d-M-Y H:i A'); ?>.
                                            </p>
                                        @endif
