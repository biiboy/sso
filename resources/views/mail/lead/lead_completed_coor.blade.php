                  ...
                  <table>
                    <tr>
                      <td style="font-family: sans-serif; font-size: 16px;">
                        ...
                        <p style="font-family: sans-serif; font-size: 16px; font-weight: normal; margin: 0; Margin-bottom: 15px;"> KPI <b>{{ $name_coor }}</b> has been completed and need your <a style="color:blue;text-decoration: underline;" href="{{ route('assessment_all_approval_appraisal',['id'=>$crement]) }}">evaluation</a> on <?php date_default_timezone_set("Asia/Jakarta"); echo date('d-M-Y H:i A') ?>.</p>
