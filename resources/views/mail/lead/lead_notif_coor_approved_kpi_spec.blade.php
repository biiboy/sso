        ...
        <tr>
            <td class="one-column">
                <table width="100%">
                    <tr>
                        <td class="inner-td">
                            <p style="padding-left: 20px; color: black">Dear <b> {{ $name_lead }},</b>
                                <br>
                                <br>
                            <p style="padding-left: 20px; color: black">
                                <b>{{ $name_coor }}</b> has approved KPI <b>{{ $name_spec }}</b> on
                                <?php date_default_timezone_set('Asia/Jakarta');
                                echo date('d-M-Y H:i A'); ?> and need your <a style="color:blue;text-decoration: underline;"
                                    href="{{ route('assessment_all_approval_approval', ['id' => $crement]) }}">review</a>.
                            </p>
                            <br>

                            <p style="color: black;"><b>Key Result Area:</b>
                            <p style="color: black;">{{ $k_label }}</p>
                            <br>

                            <p style="color: black;"><b>Goal:</b></p>
                            <p style="color: black;">{!! $goal !!}</p>
                            <br>

                            <p style="color: black;"><b>Target Date:</b></p>
                            <p style="color: black;">{{ date('d-M-Y', strtotime($k_targetdate)) }}</p>
                            <br>

                            <p style="color: black;"><b>Due Date For First Tactical Step:</b></p>
                            <p style="color: red">{{ date('d-M-Y', strtotime($kd_duedate)) }}</p>
                            <br>

                            <p style="color: black;"><b>Collaboration:</b></p>
                            <p style="color: black;">
                            ...
                            <p style="color: black;"><b>Justification:</b></p>
                            <p style="color: black;">{{ $k_justification_coor }}</p>
                            <br>

                            <p style="color: black;">Performance Appraisal</p>
                            <p style="color: black;"><strong>IT Services - PT. Gudang Garam Tbk.</strong></p>
                        </td>
                    </tr>
                </table>
            </td>
