...
@push('scripts')
    ...
    <script>
        $('.search_button').click(function() {
            $.ajax({
                type: "get",
                url: '{{ route('all_report_coor_sby_chart_cari_unit') }}',
                        ...
                        plotOptions: {
                            pie: {
                                ...
                                dataLabels: {
                                    ...
                                    format: '<b>Total {point.name}</b>:<br>{point.percentage:.1f} %<br>Total KPI: {point.y}',
                                }
                            }
                        },
                        series: [{
        ...
        Highcharts.chart('ddd', {
            ...
            colors: ['#868e96', '#ff3300', '#f9ed09', '#225bb7', '#00b300', ],
            title: {
                text: ('<strong>TOTAL PENILAIAN KPI IT Support Surabaya</strong>'),
                style: {
                    fontSize: '30px',
                    fontWeight: 'bold',
                    textTransform: 'uppercase',
            ...
            series: [{
                ...
                data: [{
                    name: 'NA',
                    y: {{ $totalna_supportsurabaya }}
                }, {
                    name: 'Unacceptable',
                    y: {{ $totalunacceptable_supportsurabaya }}
                }, {
                    name: 'Need Improvement',
                    y: {{ $totalni_supportsurabaya }}
                }, {
                    name: 'Good',
                    y: {{ $totalgood_supportsurabaya }}
                }, {
                    name: 'Outstanding',
                    y: {{ $totaloutstanding_supportsurabaya }}
                }]
            }]
        ...
        var chart = Highcharts.chart('ddd1', {
            ...
            colors: ['#ff3300', '#f9ed09', '#00b300', '#225bb7', ],
            title: {
                text: ('<strong>Total FINAL KPI IT Support Surabaya</strong>'),
                style: {
                    fontSize: '30px',
                    fontWeight: 'bold',
                    textTransform: 'uppercase',
        ...
        var chart = Highcharts.chart('ddd3', {
            ...
            colors: ['#ff3300', '#f9ed09', '#00b300', '#225bb7', ],
            title: {
                text: ('<strong>TOTAL KPI IT Support Surabaya</strong>'),
                style: {
                    fontSize: '30px',
                    fontWeight: 'bold',
                    textTransform: 'uppercase',
