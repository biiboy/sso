...
@push('scripts')
    ...
    <script>
        ...
        Highcharts.chart('ddd', {
            ...
            title: {
                text: ('<strong>TOTAL PENILAIAN KPI ALL IT Services</strong>'),
                style: {
                    fontSize: '30px',
                    fontWeight: 'bold',
            ...
            series: [{
                ...
                data: [{
                    ...
                    {
                        name: 'Good',
                        y: {{ $totalgood_services }}
                    }, {
                        name: 'Outstanding',
                        y: {{ $totaloutstanding_services }}
                    }
                ]
            }]
        });
        ...
        var chart = Highcharts.chart('ddd3', {
            ...
            title: {
                text: ('<strong>TOTAL KPI All IT Services</strong>'),
                style: {
                    fontSize: '30px',
                    fontWeight: 'bold',
                    textTransform: 'uppercase',
        ...
        Highcharts.chart('container1', {
            ...
            title: {
                text: ('<strong>Total FINAL KPI All IT Services Per Site</strong>'),
                style: {
                    fontSize: '30px',
                    fontWeight: 'bold',
                    textTransform: 'uppercase',
        ...
        $(function() {
            ...
            $('#container3').highcharts({
                ...
                title: {
                    text: ('<strong>Total FINAL KPI All IT Services Per Specialist</strong>'),
                    style: {
                        fontSize: '30px',
                        fontWeight: 'bold',
                        textTransform: 'uppercase',
                            ...
                            @if ($i == 1 && $i == 1)
                                {
                                    ...
                                    drilldown: 'drilldownhelpdesk{{ $all_site_name[$i] }}',
                                },
                            @endif
                        @endforeach
                    ],
