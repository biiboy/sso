        ...
        <form id="save">
            <div class="card-body"><br>
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-10">
                        <input class="form-control" type="text" name="k_title" id="k_title"
                            value="{{ $data->kpdf_title }}" placeholder="Key Result Area">
                    </div>
                </div>
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-10">
                        <textarea class="form-control mymce" type="text" name="k_goal" id="mymce" placeholder="Goal (WHAT)">{{ $data->kpdf_dec }}</textarea>
                    </div>
                </div>

                <div class="form-group row">
                    <label for="k_targetdate" class="col-2 col-form-label "><b>Upload File</b><span
                ...
                buttons: [
                    [
                        ...
                        function(instance, toast) {
                            ...
                            $.ajax({
                                type: "post",
                                url: '{{ route('assessment_target_update') }}',
                                ...
                                success: function(data) {
                                    if (data.status == 'sukses') {
                                        iziToast.success({
                                            ...
                                            position: 'center',
                                            title: 'Success!',
                                            message: id_status == 'save' ?
                                                'Target KPI Saved!' :
                                                'Target KPI has been Publish',
                                        });
