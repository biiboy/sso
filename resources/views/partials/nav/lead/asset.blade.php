...
<li class="nav-item mb-2 dropdown {{ request()->url() == route('assessment_all_approval') || request()->url() == route('assessment_all_review_kpi_team_all_asset') ? 'active' : '' }}">
    <a class="nav-link dropdown-toggle {{ request()->url() == route('assessment_all_approval') || request()->url() == route('assessment_all_review_kpi_team_all_asset') ? 'show' : '' }}" href="#navbar-extra" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="false">
        <span class="nav-link-icon d-md-none d-lg-inline-block">
    ...
    <div class="dropdown-menu {{ request()->url() == route('assessment_all_approval') || request()->url() == route('assessment_all_review_kpi_team_all_asset') ? 'show' : '' }}">
        <a class="dropdown-item {{ request()->url() == route('assessment_all_approval') ? 'active' : '' }}" href="{{ route('assessment_all_approval') }}">
            Approval
        </a>
        <a class="dropdown-item {{ request()->url() == route('assessment_all_review_kpi_team_all_asset') ? 'active' : '' }}" href="{{ route('assessment_all_review_kpi_team_all_asset') }}">
            Review
        </a>
    </div>
</li>
<li class="nav-item mb-2 dropdown {{ request()->is('all_report*') ? 'active' : '' }}">
    ...
    <div class="dropdown-menu {{ request()->is('all_report*') ? 'show' : '' }}">
        <a class="dropdown-item {{  request()->url() == route('all_report_asset_lead') ? 'active' : '' }}" href="{{ route('all_report_asset_lead') }}">
            KPI Chart
        </a>
        <div class="dropend">
            ...
            <div class="dropdown-menu {{ request()->is('all_report') ? 'show' : '' }}">
                <div class="dropend">
                    ...
                    <div class="dropdown-menu  {{ request()->is('all_report') ? 'show' : '' }}">
                        <a href="{{ route('all_report', ['id' => 'ALL', 'flag' => '3']) }}" class="dropdown-item">All IT Asset</a>
                        <a href="{{ route('all_report', ['id' => 'Gempol', 'flag' => '3']) }}" class="dropdown-item">Gempol</a>
                        <a href="{{ route('all_report', ['id' => 'Jakarta', 'flag' => '3']) }}" class="dropdown-item">Jakarta</a>
                        <a href="{{ route('all_report', ['id' => 'Kediri', 'flag' => '3']) }}" class="dropdown-item">Kediri</a>
                        <a href="{{ route('all_report', ['id' => 'Surabaya', 'flag' => '3']) }}" class="dropdown-item">Surabaya</a>
                    </div>
                </div>
            </div>
        </div>
